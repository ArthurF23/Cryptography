...
###### v1.8.1 & v1.8.2
##### Optimizations and comments to code.

###### v1.8.4
##### RGB pixel compression in .bmp encryption

###### v1.8.5
##### Bug fixes in RGB compression

###### v1.8.6, v1.8.7, v1.8.8, & v1.8.9
##### Bug fixes in RGB compression. There *was* a problem that would try to allocate the file size in ram before compressing. It now will only allocate a `115100` character string at a time and compress `115100` characters at a time. Speed improvements. 
...
###### v1.8.13
##### Multithreaded RGB decompression pixel assignment
